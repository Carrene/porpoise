//
//  SelectBankViewDesignable.swift
//  MobileToken
//
...
class SelectBankViewDesignable: UIView {
...
//        let nib = UINib(nibName: "AddPasswordViewDesignable", bundle: bundle)
        let view = R.nib.selectBankViewDesignable.instantiate(withOwner: self, options: nil).first as! UIView
        initUIComponent()
        return view
    }
