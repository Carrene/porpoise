...
class PasswordHintTableAdapter: NSObject,UITableViewDataSource,UITableViewDelegate{
    ...
    var sender:AuthenticationDefinitionPasswordViewController?
    
    init(sender:AuthenticationDefinitionPasswordViewController) {
        self.sender = sender
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "reusePasswordHintCell", for: indexPath) as! PasswordHintTableViewCell
